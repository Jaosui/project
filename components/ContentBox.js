...
export default function ContentBox() {
  ...
  const titleName4 = <div>NEW ALBUM FROM MARK <RightCircleOutlined /></div>
  const titleName5 = <div>NEW ALBUM FROM LALISA <RightCircleOutlined /></div>
  const titleName6 = <div>NEW ALBUM FROM TAEYEON <RightCircleOutlined /></div>
